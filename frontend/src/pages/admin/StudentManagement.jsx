  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editId) {
        ...
        flash("✅ Student updated in database.");
        setEditId(null);
      } else {
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-body">
        ...
        <div className="page-header">
          <div>
            ...
            <p>Add and manage student profiles</p>
          </div>
        ...
        {showForm && (
          <div className="form-card">
            ...
            <div className="info-tip">
              💡 <strong>Parent Email</strong> must exactly match the email the parent
              used to register — this links their login to their child's profile.
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid-form">
              ...
              <div className="form-group full email-group">
                <label>
                  ...
                  <span className="email-hint"> — must match the email the parent uses to log in</span>
                </label>
                <input
                  type="email" required
                ...
                {filtered.length === 0 ? (
                  ...
                  <tr key={s._id}>
                    ...
                    <td className="email-cell">
                      {s.parentEmail || <span className="no-email">⚠️ Not set</span>}
                    </td>
                    <td>
            ...
            <div className="modal-card" onClick={e => e.stopPropagation()}>
              ...
              <div className="modal-grid">
                ...
                <div><strong>Date of Birth</strong>
                  <p>{viewStudent.dateOfBirth ? new Date(viewStudent.dateOfBirth).toLocaleDateString("en-LK") : "—"}</p>
                </div>
                <div><strong>Enrolled Date</strong>
                  <p>{viewStudent.enrolledDate ? new Date(viewStudent.enrolledDate).toLocaleDateString("en-LK") : "—"}</p>
                </div>
                <div><strong>Status</strong>
                  <p><span className={`status-pill ${viewStudent.status === "Active" ? "active" : "inactive"}`}>{viewStudent.status}</span></p>
                </div>
                ...
                <div className="full">
                  <strong>Parent Email (login email)</strong>
                  <p>{viewStudent.parentEmail || <span className="no-email">⚠️ Not set — parent cannot view profile</span>}</p>
                </div>
              </div>
              <div className="modal-actions">
                <button className="btn-edit" onClick={() => handleEdit(viewStudent)}>Edit Student</button>
        ...
        {deleteId && (
          <div className="modal-overlay" onClick={() => setDeleteId(null)}>
            <div className="modal-card small" onClick={e => e.stopPropagation()}>
              ...
              <p>This will permanently remove this student from the database.</p>
              <div className="modal-actions">
      ...
      <style>{`
        ...
        .email-group input { border-color:#bfdbfe; background:#f0f8ff; }
        .email-group input:focus { border-color:#3b82f6; box-shadow:0 0 0 3px rgba(59,130,246,0.1); }
        ...
        .count-badge { padding:8px 18px; background:white; border-radius:20px; font-weight:600; color:#555; font-size:14px; box-shadow:0 2px 8px rgba(0,0,0,0.08); white-space:nowrap; }
        ...
        .no-email   { color:#f59e0b; font-size:12px; font-weight:600; }
        ...
        .modal-card.small { max-width:380px; text-align:center; }
        ...
        .modal-grid strong { display:block; font-size:12px; color:#aaa; margin-bottom:4px; text-transform:uppercase; letter-spacing:0.5px; }
        .modal-grid p { font-size:15px; color:#333; margin:0; }
